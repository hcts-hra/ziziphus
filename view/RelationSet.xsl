                     ...
                     <td>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(.,'')) != 0">
                              <div id="b-d2e652" data-bf-type="input" data-bf-bind="." tabindex="0"
                                   title="Relation">
                        ...
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(@relids,'')) != 0">
                              <div id="" data-bf-type="input" data-bf-bind="@relids" tabindex="0" title="relids">
                        ...
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(@type,'')) != 0">
                              <div id="b-d2e660" data-bf-type="select1" data-bf-bind="@type" tabindex="0"
                                   title="Type">
