                     ...
                     <td>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:name,'')) != 0">
                              <div data-bf-type="input" data-bf-bind="vra:name" tabindex="0" title="Name" id="b-d2e1464">
                        ...
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:name/@type,'')) != 0">
                              <div data-bf-type="select1" data-bf-bind="vra:name/@type" tabindex="0" title="Type" id="b-d2e1471">
                     ...
                     <td>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:refid,'')) != 0">
                              <div data-bf-type="input" data-bf-bind="vra:refid" tabindex="0" title="Refid" id="b-d2e1486">
                        ...
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:refid/@type,'')) != 0">
                              <div data-bf-type="select1" data-bf-bind="vra:refid/@type" tabindex="0" title="Type" id="b-d2e1493">
