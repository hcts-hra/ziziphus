                     ...
                     <td>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:name/@type,'')) != 0">
                              <div data-bf-type="select1" data-bf-bind="vra:name/@type" tabindex="0" title="Type" id="b-d2e142" class="detail">
                        ...
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:name,'')) != 0">
                              <div data-bf-type="input" data-bf-bind="vra:name" tabindex="0" title="Name" id="b-d2e135">
                     ...
                     <td>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:role/@type,'')) != 0">
                              <div data-bf-type="select1" data-bf-bind="vra:role/@type" tabindex="0" title="Type" id="b-d2e164">
                                 <xsl:value-of select="vra:role/@type"></xsl:value-of>
                              </div>
                           </xsl:when>
                           <xsl:otherwise>
                              <div class="nodata" data-bf-type="select1" data-bf-bind="vra:role/@type" tabindex="0">(Type)</div>
                           </xsl:otherwise>
                        </xsl:choose>
                        <xsl:choose>
                     ...
                     <td>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:attribution,'')) != 0">
                              <div data-bf-type="input" data-bf-bind="vra:attribution" tabindex="0" title="Attribution" id="b-d2e73">
                     ...
                     <td>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:culture,'')) != 0">
                              <div data-bf-type="input" data-bf-bind="vra:culture" tabindex="0" title="Culture" id="b-d2e94">
                     ...
                     <td>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:dates/@type,'')) != 0">
                              <div data-bf-type="select1" data-bf-bind="vra:dates/@type" tabindex="0" title="Type" id="b-d2e134" class="detail">
                                 <xsl:value-of select="vra:dates/@type"></xsl:value-of>
                              </div>
                           </xsl:when>
                           <xsl:otherwise>
                              <div class="nodata" data-bf-type="select1" data-bf-bind="vra:dates/@type" tabindex="0">(Type)</div>
                           </xsl:otherwise>
                        </xsl:choose>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:dates/vra:earliestDate/@circa,'')) != 0 and vra:dates/vra:earliestDate/@circa eq 'true'">
                              <div class="subtitle" data-bf-type="input" data-bf-bind="vra:dates/vra:earliestDate/@circa" tabindex="0" title="circa">circa</div>
                           </xsl:when>
                           <xsl:otherwise>
                              <div class="nodata" data-bf-type="input" data-bf-bind="vra:dates/vra:earliestDate/@circa" tabindex="0">(circa)</div>
                           </xsl:otherwise>
                        </xsl:choose>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:dates/vra:earliestDate,'')) != 0">
                              <div data-bf-type="input" data-bf-bind="vra:dates/vra:earliestDate" tabindex="0" title="EarliestDate" id="b-d2e118">
                                 <xsl:value-of select="vra:dates/vra:earliestDate"></xsl:value-of>
                              </div>
                           </xsl:when>
                           <xsl:otherwise>
                              <div class="nodata" data-bf-type="input" data-bf-bind="vra:dates/vra:earliestDate" tabindex="0">(EarliestDate)</div>
                           </xsl:otherwise>
                        </xsl:choose>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:dates/vra:latestDate/@circa,'')) != 0 and vra:dates/vra:latestDate/@circa eq 'true'">
                              <div class="subtitle" data-bf-type="input" data-bf-bind="vra:dates/vra:latestDate/@circa" tabindex="0" title="circa">circa</div>
                           </xsl:when>
                           <xsl:otherwise>
                              <div class="nodata" data-bf-type="input" data-bf-bind="vra:dates/vra:latestDate/@circa" tabindex="0">(circa)</div>
                           </xsl:otherwise>
                        </xsl:choose>
                        <xsl:choose>
                           <xsl:when test="string-length(string-join(vra:dates/vra:latestDate,'')) != 0">
                              <div data-bf-type="input" data-bf-bind="vra:dates/vra:latestDate" tabindex="0" title="LatestDate" id="b-d2e126">
                                 <xsl:value-of select="vra:dates/vra:latestDate"></xsl:value-of>
                              </div>
                           </xsl:when>
                           <xsl:otherwise>
                              <div class="nodata" data-bf-type="input" data-bf-bind="vra:dates/vra:latestDate" tabindex="0">(LatestDate)</div>
                           </xsl:otherwise>
                        </xsl:choose>
                     </td>
                  </tr>
